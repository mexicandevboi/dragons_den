...
<head>
    ...
    <link rel="stylesheet" href="css/producto - css/normalize.css">
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/producto-Imgs/cards.png" />
    <!-- Bootstrap icons-->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css" rel="stylesheet" />
    <!-- Core theme CSS (includes Bootstrap)-->
    <link href="css/producto - css/styles.css" rel="stylesheet" />
    <link rel="stylesheet" href="css/producto - css/product.css">
    <link rel="stylesheet" href="css/producto - css/float_action_button.css">
    ...
    <!--Se ha quitado la funcion de comprar debido a que no se esta utilizando-->
    <!--<script src="js/producto - js/app.js" async></script>-->
    <script>
        function menuVer() {
...
<body>
    ...
    <div id="header">
        <header class="topnav">
            <img id="logo" src="assets/producto-Imgs/LogoBlanco.png">
            <!-- Quiten como requieran -->
            <div id="Links">
                <button class="boton"><a href="index.php">Inicio</a></button>
            </div>
    ...
    <main>
        ...
        <script>
            const cartaMostrarString = localStorage.getItem('cartaEscogida');
            const cartaMostrar = JSON.parse(cartaMostrarString);
            console.log(cartaMostrar);
        </script>
                    ...
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <div class="d-flex">
                                ...
                                <!-- Botón para Editar -->
                                <a href="edit_card.php?id=<?php echo $id; ?>">Editar Carta</a>
